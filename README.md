# Utsav Hingar - Portfolio Website

A modern, responsive portfolio website built with React, TypeScript, and Tailwind CSS. Features smooth animations, dark mode design, and optimized performance.
...
- **Color Scheme**: Dark theme with blue and purple gradients
...
```bash
git clone https://github.com/utsavhingar/portfolio.git
cd portfolio
```
...
- `src/components/About.tsx` - Personal description and facts
