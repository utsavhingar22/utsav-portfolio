  ...
  const experiences = [
    {
      ...
      achievements: ['Won JK Internal AI Hackathon 2025', 'Integrated 50+ REST APIs'],
      logo: '🚀'
    },
    {
      ...
      achievements: ['Reached 20K+ app downloads', 'Scaled multiple EdTech platforms'],
      logo: '📱'
    },
    {
      title: 'Summer Intern',
    ...
    <section id="experience" className="section-padding relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative">
          {/* Timeline Line */}
          <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary-500 via-accent-500 to-transparent transform -translate-x-1/2"></div>
          ...
          <div className="space-y-12">
            {experiences.map((exp, index) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-4 md:left-1/2 w-4 h-4 bg-gradient-to-r from-primary-500 to-accent-500 rounded-full border-4 border-dark-900 transform -translate-x-1/2 z-10"></div>
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-6">
                      <div className="flex items-center space-x-4">
                        <div className="w-12 h-12 bg-gradient-to-r from-primary-500/20 to-accent-500/20 rounded-xl flex items-center justify-center text-2xl">
                          {exp.logo}
                        </div>
                        <div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {exp.technologies.map((tech, techIndex) => (
                          <span
                            key={techIndex}
                            className="px-3 py-1 bg-white/5 backdrop-blur-sm border border-white/10 text-gray-300 rounded-lg text-sm"
                          >
                            {tech}
                          </span>
                        ))}
