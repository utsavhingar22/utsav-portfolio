...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-dark-900 to-black overflow-hidden">
      {/* Background Elements */}
            ...
            <div className="flex space-x-3">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={`p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 text-gray-300 hover:text-white transition-all duration-300 ${social.color}`}
            ...
            <ul className="space-y-3">
              {footerLinks.quickLinks.map((link, index) => (
                ...
                >
                  <a
                    href={link.href}
                    className="text-gray-400 hover:text-white hover:gradient-text transition-all duration-200 flex items-center group"
                  >
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200"
              />
              <motion.button
